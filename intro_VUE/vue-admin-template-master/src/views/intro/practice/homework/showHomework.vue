    ...
    <div>
        ...
        <div class="show" style="margin-top: 10px;" >
            <el-form :inline="true" class="demo-form-inline" label-width="800px">
                    <el-form-item label-width="200px" label="该课后作业完成情况：" style="margin-left: 10px; float:left">
                            {{this.completion}}
                    </el-form-item>
            </el-form>
        </div>
...
export default {
    ...
    methods: {
        getList(page=1){
            ...
            homework.findHomeworkById(this.page,this.limit,this.homeworkId)
            .then(response =>{
                this.list = response.data.stuHomeworkPageById
