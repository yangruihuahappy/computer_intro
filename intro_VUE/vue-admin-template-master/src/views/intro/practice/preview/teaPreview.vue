  ...
  <div class="app-container">
    ...
    <div class="show" style="margin-top: 10px;" >
        <el-form :inline="true" class="demo-form-inline" label-width="800px">
                ...
                <el-form-item label-width="150px" label="已发布的课前预习：" prop="pass" style="margin-left: 10px; float:left">
                        {{this.total}}
                </el-form-item>
                <el-form-item>
                    <el-button style="margin-right: 20px; float:right" type="default" @click="saveOrUpdate()" >发布新的课前预习</el-button>
    ...
    <div class="show">
        ...
        <el-table
            ...
            <el-table-column label="操作" width="180" align="center">
                <template slot-scope="scope">
                    <el-button-group>
                      <el-button type="success" size="mini" icon="el-icon-search" @click="toShowPreview(scope.row.id)"></el-button>
                      <el-button type="primary" size="mini" icon="el-icon-edit" @click="saveOrUpdate(scope.row.id)"></el-button>
                      <el-button type="danger" size="mini" icon="el-icon-delete" @click="deletePreview(scope.row.id)"></el-button>
                    </el-button-group>
                </template>
            </el-table-column>
        </el-table> 
    ...
    <div>
        ...
        :before-close="handleClose">
            <el-form ref="postForm" :model="previewInfo" class="form-container">
                ...
                <el-form-item style="margin-bottom: 5px;" label-width="100px" label="标题:">
                    <el-input :rows="1" v-model="previewInfo.title" type="textarea" class="article-textarea" autosize placeholder="请输入内容"/>
                </el-form-item>

                <el-form-item style="margin-bottom: 5px;" label-width="100px" label="题目量:">
                    <el-input :rows="1" v-model="previewInfo.count" type="textarea" class="article-textarea" autosize placeholder="请输入数字"/>
                </el-form-item>

                <el-form-item style="margin-left: 4px;" label-width="100px" label="截止日期:">
                  <el-date-picker
                    v-model="previewInfo.gmtDeadline"
                    type="datetime"
                    placeholder="选择截止时间"
...
export default {
  ...
  methods: {
    ...
    getList(page=1){
        ...
        preview.findAllByTeacher(this.page,this.limit)
        .then(response =>{
            this.list = response.data.previewList
    ...
    toShowPreview(id){
      ...
      this.$router.push({ path:'/practice/showPreview/'+id})
    },
    ...
    saveOrUpdate(id){
      ...
      if(id != null){ //进行数据回显
          ...
          preview.getPreviewById(id).then( response=>{
              this.previewInfo = response.data.previewInfo
    ...
    saveOrUpdatePreview(){
      console.log(this.previewInfo);
      if(this.previewInfo.id!=null){
        preview.updatePreview(this.previewInfo).then( () =>{
          this.$message({
              type: 'success',
              message: '更新成功!'
          });
        ...
        preview.addPreview(this.previewInfo).then( () =>{
          this.$message({
              type: 'success',
              message: '添加成功!'
          });
    ...
    deletePreview(id){
      ...
      .then(_ => {
          //确认删除
        preview.deletePreviewById(id).then( ()=>{
          this.$message({
              type: 'success',
              message: '删除成功!'
          });
