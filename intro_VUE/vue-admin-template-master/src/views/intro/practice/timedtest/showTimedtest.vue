    ...
    <div>
        ...
        <div class="show" style="margin-top: 10px;" >
            <el-form :inline="true" class="demo-form-inline" label-width="800px">
                    <el-form-item label-width="200px" label="该随堂测验完成情况：" style="margin-left: 10px; float:left">
                            {{this.completion}}
                    </el-form-item>
            </el-form>
        </div>
...
export default {
    ...
    created(){
        ...
        if(this.$route.params && this.$route.params.id){
            ...
            this.timedtestId = this.$route.params.id
        }
        this.getList()
    },
    methods: {
        getList(page=1){
            ...
            timedtest.findTimedtestById(this.page,this.limit,this.timedtestId)
            .then(response =>{
                this.list = response.data.stuTimedtestPageById
